...
//var assetclass = mongoose.connection.model('AssetClass', AssetClassSchema);
...
PortfolioSchema.post('save', function(doc, next) {
	// AssetClassSchema.find({'classname' : 'Equity'}, 'derivative', function(err, der) {
	// 	console.log(der[0].derivative);
	// });
